...
# print("The title is "+data["metadata"]["title"])
...
for quake in data["features"]:
    if quake["properties"]["felt"] is not None and quake["properties"]["felt"]>500:
        count=count+1
...
for quake in data["features"]:
    if quake["properties"]["mag"] is not None and quake["properties"]["mag"] >=6:
        count = count+1
print("The total count of earthquakes having magnitude greater than 6 are " + str(count))